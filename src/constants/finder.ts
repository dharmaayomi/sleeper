    ...
    // ▶ Project 1
    {
      ...
      children: [
        ...
        },
        {
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/Syaiful313/finpro-jcwd-0610-fe",
        ...
        },
        {
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/Syaiful313/finpro-jcwd-0610-be",
    ...
    // ▶ Project 2
    {
      ...
      children: [
        ...
        },
        {
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/dharmaayomi/eventure-front",
        ...
        },
        {
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/diarifiana/eventure-back",
    ...
    // ▶ Project 3
    {
      ...
      children: [
        ...
        },
        {
          ...
          imageUrl: "/images/custom-furniture.webp",
        },
        {
          id: 3,
          name: "custom.mkv",
          ...
          posterUrl: "/images/custom-furniture.webp",
        },
        {
          id: 5,
          name: "Design.fig",
    ...
    // ▶ Project 4
    {
      ...
      children: [
...

        {
          ...
          fileType: "img",
          position: "top-52 right-80",
          imageUrl: "/images/meatlover.webp",
        },
        {
          id: 5,
          name: "Script.celtx",
...
const ABOUT_LOCATION: FolderItem = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "I'm a full-stack web developer who enjoys turning ideas into products that people can actually use. Most of my experience comes from building real-world projects, from custom furniture configurators and management systems to interactive portfolio websites",
        "I enjoy working across both frontend and backend development, designing user experiences, building application logic, and solving the challenges that connect them. What excites me most is learning new technologies and figuring out how to apply them to create meaningful solutions.",
        "Beyond coding, I also have a background in content creation, video editing, and visual design. These experiences have shaped the way I approach development—focusing not only on how a product works, but also on how it feels to use.",
        "I'm always looking for opportunities to grow, collaborate with others, and build products that combine functionality, creativity, and thoughtful user experiences.",
      ],
    },
  ],
};
